...
import NewCase from './containers/MainContent/Common/NewCase';
import ProductList from './containers/MainContent/Common/ProductList';

import AllOpenCases from './containers/MainContent/Management/AllOpenCases';
// import ContractDetail from './containers/MainContent/Management/ContractDetail';
import ContractList from './containers/MainContent/Management/ContractList';
import MgtReview from './containers/MainContent/Management/MgtReview';
import NewProduct from './containers/MainContent/Management/NewProduct';

// import MktCasesDetail from './containers/MainContent/Marketing/MktCasesDetail';
import MktOpenCases from './containers/MainContent/Marketing/MktOpenCases';

// import SalesCaseDetail from './containers/MainContent/Sales/SalesCaseDetail';
import SalesOpenCases from './containers/MainContent/Sales/SalesOpenCases';

// import SptCaseDetail from './containers/MainContent/Support/SptCaseDetail';
import SptOpenCases from './containers/MainContent/Support/SptOpenCases';
...
const routes = [
    ...
    { path:'/allOpenCases', component: AllOpenCases},
    // { path:'/contractDetail', component: ContractDetail},
    { path:'/contractList', component:ContractList},
    { path:'/mgtReview', component:MgtReview},
    { path:'/newProduct', component:NewProduct},

    // { path:'/mktCasesDetail', component:MktCasesDetail },
    { path:'/mktOpenCases', component:MktOpenCases},

    // { path:'/salesCaseDetail', component: SalesCaseDetail},
    { path:'/salesOpenCases', component: SalesOpenCases},

    // { path:'/sptCaseDetail', compoent:SptCaseDetail},
    { path:'/sptOpenCases', component:SptOpenCases},
