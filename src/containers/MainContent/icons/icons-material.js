                            ...
                            <Row className="align-items-center">
                                <Col sm="6">
                                    ...
                                    <ol className="breadcrumb">
                                        ...
                                        <li className="breadcrumb-item active">MD Icons</li>
                                    </ol>
                                </Col>
                                <Col sm="6">
                        ...
                        <Row>
                            <Col>
                                <Card>
                                    ...
                                    <CardBody>
                                        <h4 className="mt-0 header-title mb-4">Size</h4>
                        ...
                        <Row>
                            <Col>
                                <Card>
                                    ...
                                    <CardBody>
                                        <h4 className="mt-0 header-title mb-4">Rotate</h4>
                        ...
                        <Row>
                            <Col>
                                <Card>
                                    ...
                                    <CardBody>
                                        <h4 className="mt-0 header-title mb-4">Spin</h4>
...
export default connect(null, { activateAuthLayout })(IconsMaterial);
