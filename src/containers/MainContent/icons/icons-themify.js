                    ...
                    <div className="container-fluid">
                        ...
                        <Row>
                            <Col>
                                ...
                                <Card>
                                    <CardBody>
                                        <h4 className="mt-0 header-title mb-4">Web App Icons</h4>
                                        <Row className="icon-demo-content">
                                            <Col xl="3" md="4" sm="6">
                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <h4 className="mt-0 header-title mb-4">Control Icons</h4>
                                ...
                                <Card>
                                    <CardBody>
                                        <h4 className="mt-0 header-title mb-4">Text Editor</h4>
                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <h4 className="mt-0 header-title mb-4">Layout Icons</h4>
                                ...
                                <Card>
                                    <CardBody>
                                        <h4 className="mt-0 header-title mb-4">Brand Icons</h4>
...
export default connect(null, { activateAuthLayout })(IconsThemify);