...
const columns = [
    {
        ...
        sortable: true,
        selector: 'Image',
        cell: row => <div className="product-list-img">   <img src={row.Image} className="img-fluid thumb-md rounded" alt="tbl" /></div>
    },
    {
        name: 'Product Name',
        width: "450px",
        sortable: true,
        selector: 'PName',
        cell: row => <div> <h6 className="mt-0 mb-1">{row.Pname}</h6> <p className="m-0 font-14">{row.Pdesc}</p> </div>
    },
    {
        name: 'Date',
        sortable: true,
