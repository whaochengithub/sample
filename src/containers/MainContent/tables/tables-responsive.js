                            ...
                            <Col>
                                <Card>
                                    <CardBody>
                                        ...
                                        <p className="text-muted">This is an experimental awesome solution for responsive tables with complex data.</p>
...
export default connect(null, { activateAuthLayout })(Tablesresponsive);
