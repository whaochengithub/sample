...
const SideNav = () => { return <div id="sidebar-menu">
                <ul className="metismenu" id="side-menu">
                            ...
                            <li>
                                <Link to="/#" className="waves-effect"><i className="ti-target"></i><span> Marketing <span className="float-right menu-arrow"><i className="mdi mdi-chevron-right"></i></span> </span></Link>
                                <ul className="submenu">
                                    <li><Link to="/newCase">New Case</Link></li>
                                    <li><Link to="/mktOpenCases">My open cases</Link></li>
                                    <li><Link to="/productList">Product List</Link></li>
                                </ul>
                            </li>

                            <li>
                                <Link to="/#" className="waves-effect"><i className="ti-shopping-cart"></i><span> Sales <span className="float-right menu-arrow"><i className="mdi mdi-chevron-right"></i></span> </span></Link>
                                <ul className="submenu">
                                    <li><Link to="/newCase">New Case</Link></li>
                                    <li><Link to="/salesOpenCases">My open cases</Link></li>
                                    <li><Link to="/productList">Product List</Link></li>
                                </ul>
                            </li>

                            <li>
                                <Link to="/#" className="waves-effect"><i className="ti-bookmark-alt"></i><span> Support <span className="float-right menu-arrow"><i className="mdi mdi-chevron-right"></i></span> </span></Link>
                                <ul className="submenu">
                                    <li><Link to="/sptOpenCases">My open cases</Link></li>
                                    <li><Link to="/productList">Product List</Link></li>
                                </ul>
                            </li>

                            <li>
                                <Link to="/#" className="waves-effect"><i className="ti-crown"></i><span> Managment <span className="float-right menu-arrow"><i className="mdi mdi-chevron-right"></i></span> </span></Link>
                                <ul className="submenu">
                                    <li><Link to="/allOpenCases">All open cases</Link></li>
                                    <li><Link to="/contractList">Pending contract</Link></li>
                                    <li><Link to="/newProduct">New Product</Link></li>
                                    <li><Link to="/mgtReview">Performance review</Link></li>
                                </ul>
                            </li>
